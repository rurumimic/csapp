...
```txt
        ...
        0x06         0x16           0x2d          0x6b
     ┌───┴───┐     ┌───┴───┐      ┌───┴───┐     ┌───┴───┐
   0x01    0x07  0x14    0x23   0x28    0x2f  0x63   0x03e9
```
...
```txt
          ...
          ┌─────────────┴─────────────┐                             ┌───────────────┴──────────────┐
          0                           2                             1                              3
        2*2*0                     2*(2*0+1)                    2*(2*0)+1                       2*(2*0+1)+1
     ┌────┴────┐               ┌──────┴───────┐               ┌─────┴──────┐               ┌───────┴────────┐
     0         4               2              6               1            5               3                7
 2*2*2*0  2*2*(2*0+1)  2*(2*(2*0)+1)  2*(2*(2*0+1)+1)  2*2*(2*0)+1  2*2*(2*0+1)+1  2*(2*(2*0)+1)+1  2*(2*(2*0+1)+1)+1
```
